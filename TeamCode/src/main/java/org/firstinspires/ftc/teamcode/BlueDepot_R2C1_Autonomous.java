...
public class BlueDepot_R2C1_Autonomous extends LinearOpMode {
    ...
    // Motor/servo powers
    private static final double EJECTION_POWER = 0.7;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            //
            double distance = 46;
            encoderDrive(DRIVE_SPEED, -distance, distance, distance, -distance, 10.0);
            sleep(300);
            ...
            telemetry.addData("Step", "14: Rotate 130° CW");
            telemetry.update();
            rotate(TURN_SPEED, 130, 5.0);
            sleep(300);
            ...
            telemetry.addData("Step", "22: Rotate 130° CCW");
            telemetry.update();
            rotate(TURN_SPEED, -130, 5.0);
            sleep(300);
